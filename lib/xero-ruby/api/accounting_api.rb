...
module XeroRuby
  class AccountingApi
    ...
    # @param xero_tenant_id [String] Xero identifier for Tenant
    # @param [Hash] opts the optional parameters
    # @option opts [Time] :if_modified_since Only records created or modified since this timestamp will be returned
    ...
    # @param xero_tenant_id [String] Xero identifier for Tenant
    # @param [Hash] opts the optional parameters
    # @option opts [Array<String>] :ids Filter by BudgetID. Allows you to retrieve a specific individual budget.
    # @option opts [Date] :date_to Filter by start date
    # @option opts [Date] :date_from Filter by end date
    # @return [Budgets]
    ...
    # @option opts [String] :where Filter by an any element
    # @option opts [String] :order Order by an any element
    # @option opts [Array<String>] :ids Filter by a comma separated list of ContactIDs. Allows you to retrieve a specific set of contacts in a single call.
    ...
    # @option opts [String] :where Filter by an any element
    # @option opts [String] :order Order by an any element
    # @option opts [Array<String>] :ids Filter by a comma-separated list of InvoicesIDs.
    # @option opts [Array<String>] :invoice_numbers Filter by a comma-separated list of InvoiceNumbers.
    # @option opts [Array<String>] :contact_ids Filter by a comma-separated list of ContactIDs.
